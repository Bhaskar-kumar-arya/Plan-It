          ...
          >
            ...
            {trip.owner === user?._id && (
              <button
                ...
                className="absolute z-20 top-4 right-4 flex items-center justify-center p-2 rounded-full text-foreground-secondary hover:bg-red-500 hover:text-white transition-colors"
